...
async function backfillBaselineSnapshot() {
  await getSql()`
    ...
    VALUES (
      ${BASELINE_SNAPSHOT.symbol},
      ${BASELINE_SNAPSHOT.name},
      ${BASELINE_SNAPSHOT.snapshot_date},
      ${BASELINE_SNAPSHOT.large_holders},
      ${BASELINE_SNAPSHOT.large_shares},
      ${BASELINE_SNAPSHOT.large_percentage},
      ${BASELINE_SNAPSHOT.under_1_lot_holders},
      ${BASELINE_SNAPSHOT.under_1_lot_shares},
      ${BASELINE_SNAPSHOT.under_1_lot_percentage},
      ${BASELINE_SNAPSHOT.over_1_lot_holders},
      ${BASELINE_SNAPSHOT.over_1_lot_shares},
      ${BASELINE_SNAPSHOT.over_1_lot_percentage},
      ${BASELINE_SNAPSHOT.over_10_lot_holders},
      ${BASELINE_SNAPSHOT.over_10_lot_shares},
      ${BASELINE_SNAPSHOT.over_10_lot_percentage},
      ${BASELINE_SNAPSHOT.over_100_lot_holders},
      ${BASELINE_SNAPSHOT.over_100_lot_shares},
      ${BASELINE_SNAPSHOT.over_100_lot_percentage},
      ${BASELINE_SNAPSHOT.over_400_lot_holders},
      ${BASELINE_SNAPSHOT.over_400_lot_shares},
      ${BASELINE_SNAPSHOT.over_400_lot_percentage},
      ${BASELINE_SNAPSHOT.total_holders},
      ${BASELINE_SNAPSHOT.total_shares},
      ${BASELINE_SNAPSHOT.source},
      ${BASELINE_SNAPSHOT.frequency}
    )
